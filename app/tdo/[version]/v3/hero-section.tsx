...
export default function HeroSection({ titleRedLine, redLine, formName, onSubmit, submitError }: ContainerProps) {
  ...
  return (
    <section
      id="hero"
      className="flex h-[1100px] flex-col items-center md:justify-center justify-start overflow-hidden bg-[#071117] bg-[url('/images/tdo/v3/bg_mobile_primeira_dobra.webp')] bg-cover bg-top px-4 pt-2 md:h-[900px] md:bg-[url('/images/tdo/v3/bg.webp')] md:px-0"
    >
      <div className="flex w-full flex-col items-center justify-center pt-[400px] md:w-[1080px] md:flex-row md:items-start md:justify-start md:pt-6 mt-16">
